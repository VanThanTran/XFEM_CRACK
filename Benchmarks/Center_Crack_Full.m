...
LElem  = 1/6;                                                              % Element Length

DOMAIN = [Width/LElem,Height/LElem,LElem,LElem];
MAT    = [100,0.3,20E6,0.3,2,0,Inf];

alpha = 45*pi/180;
a = 1;
CRACK = ([cos(alpha) -sin(alpha); sin(alpha) cos(alpha)]*[-a/2 0;a/2 0]')' + [Width/2 Height/2;Width/2 Height/2];
% CRACK  = [4.29289321881345 4.29289321881345; 5.70710678118655 5.70710678118655];
