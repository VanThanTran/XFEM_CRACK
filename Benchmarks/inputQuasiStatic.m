...
% GROW(1,:)   = Paris Law:, Number of cycles(1), Cycles per iteration(2), C(3), m(4), beta(5), beta1(6), n(7)
...
Width  = 0.6;                                                               % Domain Width
LElem  = 1/450;                                                             % Element Length

DOMAIN = [Width/LElem,Height/LElem,LElem,LElem];
MAT    = [71.7E9,0.33,0,0,2,0,30E6 1 4];
% MAT    = [71.7E9,0.33,0,0,2,0,30E6];
CRACK  = [0 Height/2;0.02 Height/2];
INC    = [];
VOID   = [];
GROW   = [2500 50 1.5E-10 3.8 0.7 0.84 0.35];
