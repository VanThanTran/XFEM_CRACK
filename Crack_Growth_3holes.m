...
nny = 201; % number of nodes in y-direction

DOMAIN = [(nnx-1),(nny-1),W/(nnx-1),H/(nny-1)];

% LElem  = 1/499;                                                             % Element Length
% % DOMAIN = [Width/LElem,Height/LElem,LElem,LElem];
% nEx = 99; lx = Width/nEx; nEy = 199; ly = Height/nEy;
% DOMAIN = [nEx nEy lx ly];

MAT    = [71.7E9,0.3,0,0,2,0,30E6 2.2 1 520e6];   % Alumninum alloy 7075-T6
% MAT    = [71.7E9,0.33,0,0,2,0,30E6];
CRACK  = [0 15+1e-3; 1.5 15+1e-3]; % case A
% CRACK  = [0 16; 1 16]; % case B

INC    = [];
VOID   = [2.75 14 0.25; 4.75 14 0.25; 6.75 14 0.25];
GROW   = [25 0.15];  
FORCE  = [6 -10 0];  
