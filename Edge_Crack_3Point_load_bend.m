...
nnx = 151; % number of nodes in x-direction
nny = 541; % number of nodes in y-direction

% H = 150;                                                                 % Domain Height
% W = 675;                                                                 % Domain Width
%                                                             
% nnx = 541; % number of nodes in x-direction
% nny = 151; % number of nodes in y-direction

DOMAIN = [(nnx-1),(nny-1),W/(nnx-1),H/(nny-1)];

% LElem = 1;   % Element Length
% DOMAIN = [W/LElem,H/LElem,LElem,LElem];

MAT    = [3E7,0.3,20E6,0.3,2,0,Inf];
% CRACK  = [0 H/2; W/2 H/2];
CRACK  = [0 H/2+0.25; W/2 H/2+0.25];
...
%%-------- boundary conditions----------------------
BC     = 9;  % with the presence of upper constraint
% BC     = 10;  % without the presence of upper constraint
%$--------------------------------------------

PLOT   = zeros(5,7);

PLOT(2,:) = [1 0 0 1 1 1 0];
PLOT(4,:) = [1 1 0 0 0 0 0];
PLOT(5,:) = [0 0 1 0 0 0 0];
